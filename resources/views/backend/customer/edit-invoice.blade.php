            ...
            <div class="card">
              <div class="card-header">
                <h3>Edit Invoice (Invoice No # {{$payment['invoice']['invoice_no']}})
                  <a class="btn btn-success float-right btn-sm" href="{{route('customers.credit')}}"><i class="fa fa-list"></i>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                      <label>Date</label>
                      <input type="text" name="date" placeholder="YYYY-MM-DD" readonly id="date" class="form-control datepicker form-control-sm">
                    </div>
