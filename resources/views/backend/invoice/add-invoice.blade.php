          ...
          <section class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3>Add Invoice
                  <a class="btn btn-success float-right btn-sm" href="{{route('invoice.view')}}"><i class="fa fa-list"></i>
                    Invoice List
                  </a>
                </h3>
              </div>
              ...
              <div class="card-body">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                      <label>Date</label>
                      <input type="text" name="date" placeholder="YYYY-MM-DD" readonly id="date" class="form-control datepicker form-control-sm" value="{{$date}}">
                    </div>
