...
<head>
  ...
  <!-- <script src="{{asset('public/backend')}}/plugins/daterangepicker/datepicker.css"></script> -->
  <!-- summernote -->
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; Ashik <a href="https://adminlte.io"></a>.</strong>
    <div class="float-right d-none d-sm-inline-block">
      <b>Designed & Developed by</b> Ashikul Islam
    </div>
  </footer>
...
<!-- <script src="{{asset('public/backend')}}/plugins/daterangepicker/datepicker.js"></script> -->
<!-- Tempusdominus Bootstrap 4 -->
