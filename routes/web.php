...
// 	Route::get('/add','Backend\UserController@add')->name('sliders.add');
// 	Route::post('/store','Backend\UserController@store')->name('sliders.store');
// 	Route::get('/edit/{id}','Backend\UserController@edit')->name('sliders.edit');
// 	Route::post('/update/{id}','Backend\UserController@update')->name('sliders.update');
// 	Route::get('/delete/{id}','Backend\UserController@delete')->name('sliders.delete');
// });
